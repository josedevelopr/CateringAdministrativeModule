...
INSERT INTO `tb_alimento` VALUES (1,'Ceviche',1,30.00,NULL),(2,'Juanes',3,30.00,NULL);
...
INSERT INTO `tb_auditoriausuario` VALUES (1,11,'TB_USUARIO','CREAR NUEVO USUARIO','2019-06-24 22:50:53'),(2,11,'TB_USUARIO','USUARIO ACTUALIZADO','2019-06-24 22:51:58');
...
INSERT INTO `tb_tipoalimento` VALUES (1,'Marino',NULL),(2,'Criollo',NULL),(3,'Selvatico',NULL);
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_ALIM_UPDATE`(
al_int_idalim int ,
al_vchar_descr varchar(30) ,
al_int_idtipoalim int(11) ,
al_dec_precalim decimal(9,2),
al_int_est int
)
BEGIN
UPDATE  TB_ALIMENTO SET
al_int_idalim=al_int_idalim,
al_vchar_descr=al_vchar_descr,
al_int_idtipoalim=al_int_idtipoalim,
al_dec_precalim=al_dec_precalim,
al_int_est=al_int_est
WHERE al_int_idalim=al_int_idalim;
END ;;
DELIMITER ;


/*!50003 DROP PROCEDURE IF EXISTS `SP_ALIM_DELETE` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_ALIM_DELETE`(al_int_idalim int)
BEGIN
DELETE FROM TB_ALIMENTO WHERE al_int_idalim=al_int_idalim;
END ;;
...
/*!50003 SET collation_connection  = @saved_col_connection */ ;
ALTER DATABASE `bd_catering` CHARACTER SET utf8 COLLATE utf8_general_ci ;
/*!50003 DROP PROCEDURE IF EXISTS `SP_USU_INSERT` */;
ALTER DATABASE `bd_catering` CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_USU_INSERT`(
x_int_idtipousu	int,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_USU_LIST`(x_id int, x_tipo varchar(10))
BEGIN
...
-- Dump completed on 2019-06-26  0:43:51
